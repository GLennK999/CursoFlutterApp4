...
class _RecipesViewState extends State<RecipesView> with SingleTickerProviderStateMixin{
                   ...
                   ? Center(
                       child: Column(
                         children: [
                           ...
                           Expanded(
                             child: Padding(
                               padding: EdgeInsets.only(top:200.0 - _animation.value), //ALTERAR O VALOR COM ANIMAÇÂO
